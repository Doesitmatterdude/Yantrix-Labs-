...
export function AiAuditCta() {
  ...
  return (
    <section className="relative overflow-hidden py-20 sm:py-24 final-cta-section">
      {/* Background — reuses exact final-cta styling from globals.css */}
      <div
        aria-hidden
      ...
      <div className="mx-auto max-w-4xl px-4 text-center sm:px-6">
        ...
        >
          ...
          <h2 className="mt-8 text-balance font-display text-[clamp(2.5rem,6vw,4.5rem)] leading-[1.02] tracking-tight">
            ...
            <span className="italic text-brand"> website is missing?</span>
          </h2>

          <p className="mx-auto mt-6 max-w-2xl text-pretty text-muted-foreground sm:text-lg">
            Join 500+ businesses who uncovered hidden issues and unlocked
            growth with a free Yantrix AI Audit.
          </p>
